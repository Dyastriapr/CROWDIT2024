  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl w-full space-y-8">
        <div>
          <h2 className="text-center text-3xl font-extrabold text-gray-900">Hubungi Kami</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2 space-y-4">
            <h3 className="text-xl font-bold">Formulir Kontak Ulak</h3>
          ...
          <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-4">Kirim pesan Anda sekarang!</h3>
            <form className="space-y-4">
              ...
              <div className="form-control">
                ...
                <input type="email" placeholder="you@company.com" className="input input-bordered" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Telepon</span>
                </label>
                <input type="tel" placeholder="(+355) 282 872 25" className="input input-bordered" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Perusahaan (opsional)</span>
                </label>
                <input type="text" placeholder="Perusahaan Anda" className="input input-bordered" />
              </div>
              <div className="form-control">
                <label className="label">
                  <span className="label-text">Pesan</span>
                </label>
                <textarea className="textarea textarea-bordered" placeholder="Judul pesan di sini"></textarea>
              </div>
              <div className="form-control">
                <label className="label cursor-pointer">
                  <input type="checkbox" className="checkbox" />
                  <span className="label-text ml-2">Saya menerima <a href="#" className="text-blue-500">kebijakan privasi</a> situs web ini.</span>
                </label>
              </div>
              <div>
