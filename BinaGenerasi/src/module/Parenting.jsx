    ...
    <div className="p-4">
      ...
      <div className='flex flex-col md:flex-row mt-10 '>
        ...
        <div className='w-full md:w-2/3 mt-6 md:mt-0'>
          <p className='text-justify'>Parenting adalah proses berkelanjutan yang berlangsung selama masa tumbuh kembang anak dari lahir hingga mereka dewasa. Setiap tahapan memiliki keunikan dan tantangan tersendiri. Berikut ini adalah garis besar tahapan utama dalam tumbuh kembang anak dari bayi baru lahir hingga mereka mencapai kemandirian penuh (Silahkan Pilih Masa Parenting Anak):</p>
          <p className='mt-5 font-bold text-justify'>{content || "Pilih tahapan untuk melihat detail lebih lanjut."}</p>

          <div className='btn bg-primary text-white hover:bg-primary mt-10'>
