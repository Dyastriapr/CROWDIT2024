    ...
    <div className='px-10 mt-10'>
      ...
      <div className='flex flex-wrap justify-center '>
        ...
        <div className='w-96 h-96 flex flex-col items-center justify-center bg-white rounded'>
          ...
          <p className='text-justify p-5'>Melindungi anak secara berlebihan dapat menghambat kemandirian dan kemampuan mereka untuk menghadapi tantangan.</p>
        </div>
        <div className='lg:w-96 lg:h-96 bg-primary bg-opacity-30 relative w-64 h-64'>
      ...
      <div className='flex flex-wrap justify-center'>
        <div className='w-96 h-96 flex flex-col items-center justify-center bg-white rounded'>
          ...
          <p className='text-justify p-5'>Tidak meluangkan waktu untuk berbicara dan mendengarkan anak dapat menghambat perkembangan emosional dan sosial mereka.</p>
        </div>
        <div className='lg:w-96 lg:h-96 bg-primary bg-opacity-30 relative w-64 h-64'>
