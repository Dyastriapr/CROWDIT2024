    ...
    <div className="flex flex-col md:flex-row w-full md:mt-10">
      ...
      <div className="hidden md:flex w-full md:w-1/2 items-center justify-center overflow-x-auto">
        <div className="flex flex-row space-x-4 p-4">
          <img src={imgHero} alt="Family Outdoor" className="rounded-xl w-44 h-80 object-cover shadow-md border-2 mb-20 border-solid border-primary" />
          <img src={imgHero2} alt="Father and Child" className="rounded-xl w-44 h-80 object-cover shadow-md mt-10 border-2 border-solid border-primary" />
          <img src={imgHero3} alt="Mother and Child" className="rounded-xl w-44 h-80 object-cover shadow-md mt-20 border-2 border-solid border-primary" />
        </div>
      </div>
    </div>
  )
