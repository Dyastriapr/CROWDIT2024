  ...
  return (
    <div id='manfaat' className="bg-white p-8 shadow-md container mx-auto">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col items-center p-4 shadow rounded-lg hover:scale-105 transition-transform duration-300"  data-aos="fade-up" data-aos-duration="500">
        ...
        <div className="flex flex-col items-center p-4 shadow rounded-lg hover:scale-105 transition-transform duration-300"data-aos="fade-up" data-aos-duration="1000">
        ...
        <div className="flex flex-col items-center p-4 shadow rounded-lg hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-duration="1500">
        ...
        <div className="flex flex-col items-center p-4 shadow rounded-lg hover:scale-105 transition-transform duration-300" data-aos="fade-up" data-aos-duration="2000">
