...
<div className='container mx-auto overflow-x-hidden'>
    ...
    <div className=' flex flex-col lg:flex-row py-10'>
      <div className='w-full lg:w-2/3 px-5'>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md" data-aos="fade-right" data-aos-duration="500">
        ...
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md"  data-aos="fade-right" data-aos-duration="1500" >
          <input type="radio" name="my-accordion-2" />
        ...
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md" data-aos="fade-right" data-aos-duration="2000" >
          <input type="radio" name="my-accordion-2" />
        ...
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md" data-aos="fade-right" data-aos-duration="2500">
          <input type="radio" name="my-accordion-2" />
        ...
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md" data-aos="fade-right" data-aos-duration="3000">
          <input type="radio" name="my-accordion-2" />
