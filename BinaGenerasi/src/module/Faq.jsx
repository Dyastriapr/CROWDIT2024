    ...
    <div className='container mx-auto flex flex-col lg:flex-row py-10'>
      ...
      <div className='w-full lg:w-2/3 px-5'>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Layanan Hourly Place kami menawarkan berbagai jenis ruang yang dapat disewa secara per jam, termasuk kamar mandi, ruang individu, dan tempat parkir, yang memenuhi berbagai kebutuhan dan preferensi.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Fitur Roommate memungkinkan Anda menemukan dan mengatur teman sekamar untuk ruang berbagi, memastikan kompatibilitas dan kesepakatan bersama.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          <input type="radio" name="my-accordion-2" />
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Ya, Anda dapat menjelajahi dan melihat ruang yang tersedia tanpa akun, tetapi untuk memesan Anda harus membuat akun untuk tujuan verifikasi.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          <input type="radio" name="my-accordion-2" />
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Last-Minute Deals adalah penawaran khusus untuk ruang yang tersedia dengan harga diskon untuk pemesanan di hari yang sama.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          <input type="radio" name="my-accordion-2" />
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Login diperlukan untuk memesan hotel dan mengakses Last-Minute Deals untuk memastikan identitas dan detail pemesanan Anda aman.</p>
          </div>
        </div>
        <div className="collapse collapse-arrow bg-white mt-2 shadow-md">
          <input type="radio" name="my-accordion-2" />
          ...
          <div className="collapse-content">
            <p className="text-sm lg:text-base">Ya, Anda dapat membatalkan pemesanan atau pengaturan teman sekamar, tergantung pada syarat dan ketentuan yang tercantum dalam perjanjian layanan.</p>
          </div>
        </div>
      </div>
      ...
      <div className='w-full lg:w-1/3 p-5 mt-10 lg:mt-0'>
        <div className="bg-white px-5 py-10 shadow-md rounded-md text-center">
          ...
          <p className="text-sm lg:text-base mb-4">Platform yang menyeluruh dan ramah pengguna yang menghubungkan Anda dengan apa yang Anda cari, menyederhanakan proses pencarian Anda dengan mudah.</p>
